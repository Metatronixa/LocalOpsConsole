...
const shots = [
  ...
  { file: 'threat-operations.png', module: 'threatoperations', category: 'Security', caption: 'Threat Operations — security event stream' },
  ...
  { file: 'fleet.png', module: 'fleet', category: 'Operations', caption: 'Computers — fleet agents and drawer' },
  { file: 'network-map.png', module: 'networkmap', category: 'Operations', caption: 'Network Map — gateway clusters' },
