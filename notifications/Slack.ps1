# notifications/Slack.ps1 - Incoming webhook

function Send-LocNotifySlack {
    param(
        [object]$Alert,
        [object]$Incident,
        [object]$Config = $null
    ...
    try {
        ...
        $text = "*[$($Alert.Severity)] $($Alert.Title)*`n$($Alert.Message)"
        ...
        Write-LocLog -Module "EVENTINTEL" -Action "Slack" -Level "WARN" -Message $_.Exception.Message
